...
The platform provides a publicly accessible dashboard, a structured reporting form for submitting new case reports, and a protected administration area for authorized users.
...
Database PostgreSQL is used for data storage. Connection settings must be configured according to the local environment.
